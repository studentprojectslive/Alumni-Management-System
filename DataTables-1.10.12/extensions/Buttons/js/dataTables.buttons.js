...
var Buttons = function( dt, config )
{
	...
	// Dont want a deep copy for the buttons
	if ( config.buttons ) {
...
$.extend( Buttons.prototype, {
	 ...
	 * @param  {node} node Button node
	 * @param  {array} [buttons] Button array, uses base if not defined
	 * @return {array} Buttons host array
	 * @private
	 */
	...
	/**
	 * Handle a key press - determine if any buttons key configured matches
...
$.extend( _dtButtons, {
	collection: {
		...
		action: function ( e, dt, button, config ) {
			...
			setTimeout( function () {
				// This is bonkers, but if we dont have a click listener on the
