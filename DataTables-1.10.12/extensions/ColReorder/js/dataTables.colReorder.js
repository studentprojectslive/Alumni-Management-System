...
var ColReorder = function( dt, opts )
{
	...
	// Ensure that we cant initialise on the same table twice
...
$.extend( ColReorder.prototype, {
	...
	"_fnMouseMove": function ( e )
	{
		...
		// The insert element wasnt positioned in the array (less than
...
ColReorder.defaults = {
	...
	/**
	 * Redraw the tables column ordering as the end user draws the column
