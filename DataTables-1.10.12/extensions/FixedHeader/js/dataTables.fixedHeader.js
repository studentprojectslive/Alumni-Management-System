...
/**
 * @summary     FixedHeader
 * @description Fix a tables header or footer, so it is always visible while
 *              scrolling
 * @version     3.1.2
...
$.extend( FixedHeader.prototype, {
	 ...
	 * header columns. That isnt present in the footer so to have it still
	...
	_modeChange: function ( mode, item, forceChange )
	{
		...
		// Record focus. Browsers will cause input elements to loose focus if
		...
		if ( mode === in-place ) {
			// Insert the header back into the tables real header
