...
*/
(function(b){"function"===typeof define&&define.amd?define(['jquery","datatables.net'],function(a){return b(a,window,document)}):"object"===typeof exports?module.exports=function(a,d){a||(a=window);if(!d||!d.fn.dataTable)d=require("datatables.net")(a,d).$;return b(d,a,a.document)}:b(jQuery,window,document)})(function(b,a,d){var e=b.fn.dataTable;b.extend(!0,e.defaults,{dom:"<ui grid<row<eight wide columnl><right aligned eight wide columnf>><row dt-table<sixteen wide columntr>><row<seven wide columni><right aligned nine wide columnp>>>",
