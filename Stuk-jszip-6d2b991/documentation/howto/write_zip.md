...
With only javascript, this part wont work in old browsers, including IE < 10.
...
isnt much better with just `Unknown`.
...
to download files to a users computer with a filename that you can choose.
